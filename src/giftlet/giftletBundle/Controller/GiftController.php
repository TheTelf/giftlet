...
use giftlet\giftletBundle\Form\GiftType;
...
class GiftController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('giftletBundle:Gift')->findAll();

        return $this->render('giftletBundle:Gift:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('giftletBundle:Gift:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('giftletBundle:Gift')->find($id);
        ...
        return $this->render('giftletBundle:Gift:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('giftletBundle:Gift:edit.html.twig', array(
            'entity'      => $entity,
